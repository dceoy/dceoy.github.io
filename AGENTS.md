...
- Preserve the copyright/source attribution at the top of `dead-simple-grid.css` when editing vendored rules; the upstream repository did not include a separate LICENSE file when the CSS was vendored.
